...
nnoremap <space>3 :<C-U>colo zenwritten<cr>
nnoremap <space>4 :<C-U>colo github-monochrome-solarized<cr>
...
autocmd vimrc ColorScheme nano-theme hi StatusLineNC guifg=#677691 guibg=NONE
